namespace SettlersOfCatan
{
	partial class RemoveCardsForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.RemoveInstructionLabel = new System.Windows.Forms.Label();
			this.WoolComboBox = new System.Windows.Forms.ComboBox();
			this.OreComboBox = new System.Windows.Forms.ComboBox();
			this.BrickComboBox = new System.Windows.Forms.ComboBox();
			this.GrainComboBox = new System.Windows.Forms.ComboBox();
			this.LumberComboBox = new System.Windows.Forms.ComboBox();
			...
			this.InstructionLabel.Text = "Since a 7 was rolled and you have ";
			// 
			...
			this.RemoveInstructionLabel.Text = "you must remove ";
			// 
			// WoolComboBox
			// 
			...
			this.WoolComboBox.Text = "Remove Amount";
			// 
			// OreComboBox
			// 
			...
			this.OreComboBox.Text = "Remove Amount";
			// 
			// BrickComboBox
			// 
			...
			this.BrickComboBox.Text = "Remove Amount";
			// 
			// GrainComboBox
			// 
			...
			this.GrainComboBox.Text = "Remove Amount";
			// 
			// LumberComboBox
			// 
			...
			this.LumberComboBox.Text = "Remove Amount";
			// 
			// RemoveCardsButton
			// 
			...
			this.RemoveCardsButton.Text = "Remove";
			this.RemoveCardsButton.UseVisualStyleBackColor = true;
			this.RemoveCardsButton.Click += new System.EventHandler(this.RemoveCardsButton_Click);
			// 
			// NumberOfCardsInHandLabel
			// 
			...
			this.NumberOfCardsInHandLabel.Text = "8 cards, ";
			// 
			// AmountToRemoveLabel
			// 
			...
			this.Controls.Add(this.LumberComboBox);
			this.Controls.Add(this.GrainComboBox);
			this.Controls.Add(this.BrickComboBox);
			this.Controls.Add(this.OreComboBox);
			this.Controls.Add(this.WoolComboBox);
			this.Controls.Add(this.RemoveInstructionLabel);
			this.Controls.Add(this.InstructionLabel);
			this.Controls.Add(this.BrickLabel);
			this.Controls.Add(this.GrainLabel);
			this.Controls.Add(this.LumberLabel);
		...
		private System.Windows.Forms.Label RemoveInstructionLabel;
		private System.Windows.Forms.ComboBox WoolComboBox;
		private System.Windows.Forms.ComboBox OreComboBox;
		private System.Windows.Forms.ComboBox BrickComboBox;
		private System.Windows.Forms.ComboBox GrainComboBox;
		private System.Windows.Forms.ComboBox LumberComboBox;
